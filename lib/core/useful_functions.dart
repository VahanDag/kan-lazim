...
Container requestCard(
    {required BuildContext context,
    required RequestModel item,
    required bool isOwnerPage,
    Function(bool state)? isRemoved}) {
  return Container(
    height: context.deviceHeight * 0.30,
    alignment: Alignment.center,
    decoration: BoxDecoration(
        borderRadius: PaddingBorderConstant.borderRadius, border: Border.all(color: getUgencyColor(item.ugency ?? ""))),
    ...
    child: Column(
      ...
      children: [
            ...
            children: [
                ...
                child: Stack(
                  ...
                  children: [
                    Container(
                      ...
                      decoration:
                          BoxDecoration(color: Colors.red.shade100, borderRadius: PaddingBorderConstant.borderRadiusMedium),
                    ),
                    Column(
                      children: [
                        Text(
                          item.bloodType ?? "",
                          style:
                              context.textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold, color: ColorsConstant.red),
                        ),
                        Text(
              ...
              Padding(
                ...
                child: InkWell(
                    ...
                    child: Icon(
                      isOwnerPage ? Icons.cancel_outlined : Icons.share,
                      color: isOwnerPage ? ColorsConstant.red : null,
                    )),
              )
            ],
          ),
        ...
        Container(
          ...
          decoration:
              BoxDecoration(color: getUgencyColor(item.ugency ?? ""), borderRadius: PaddingBorderConstant.borderRadiusLow),
        )
      ],
    ),
  );
